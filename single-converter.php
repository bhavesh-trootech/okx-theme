...
<div class="main-wrapper">
        ...
        $chnagedataall = json_decode(json_encode($chnagedata), true);
         ...
         foreach($lostofallnew['crypto'] as $valusymbol){ 
          ...
          if($valusymbol['symbol'] == strtoupper($coinfrom)){
            ...
            curl_setopt_array($curl, array(
              CURLOPT_URL => 'https://api.coingecko.com/api/v3/coins/markets?vs_currency='.$vs_currency.'&symbol='.$string.'&per_page=1&page=1&sparkline=false',
              CURLOPT_RETURNTRANSFER => true,
              CURLOPT_ENCODING => '',
              CURLOPT_MAXREDIRS => 10,
              CURLOPT_TIMEOUT => 0,
  ...
  ?>
      ...
      <section class="banner section-gap">
            <div class="container">
                <img src="<?=get_stylesheet_directory_uri()?>/assets/images/Group 13060.png" class="banner-img" alt="">
               <div class="banner-inner">
                    <div class="row">
                        <div class="col-lg-6">
                        <div class="heading">
                            <h1>Convert <?php echo $coinfromname; ?> to <?php echo $cointoname; ?>( <?php  echo strtoupper($cointo);  ?>)</h1>
                        </div>
                        <div class="bitcoin-box  align-items-center">
                            ...
                            <div class="customvalueof" id="valueofcust"><span><span id="coinferomustval"></span> <span id="coinferomust"></span> ≈ <span id="cointoustval"></span> <span id="cointocust"></span></span></div>
                        ...
                        <div class="heading">
                         ...
                         <?php 
                            $incre='';
                            $mystring=$assertprice[0]['price_change_24h'];  
                            $ratemy=$finalratedata['rate'];  
                         ...
                         ?>
                            <h3>Convert (<?php echo  strtoupper($coinfrom);?>) to (<?php echo  strtoupper($cointo);?>) Converter | Convert <?php echo  $coinfromname;?> (<?php echo  strtoupper($coinfrom);?>) to <?php echo  $cointoname;?>(<?php echo  strtoupper($cointo);?>)</h3>
                           <p><strong style="color:#000;">(<?php echo  strtoupper($cointo);?>) is on the (rise/decline) this week.</strong></p>
                          <p>The (<?php echo  strtoupper($coinfrom);?>) to (<?php echo  strtoupper($cointo);?>) rate today is (<?php echo $finalratedata['rate'] ?>), up <?php echo $finalratedata['high']; ?>% gain over the last 24 hours.
                            The price of <?php echo  ($cointoname);?> has <?php echo  $fallen; ?> by  <?php echo $finalratedata['change_pct'] ?>% in the past seven days. In the past 24 hours, 
                            the price of <?php echo  strtoupper($cointo);?> <?php echo $incre; ?> by <?php echo $finalratedata['change']; ?>% amount. (<?php echo  strtoupper($cointo);?>) is 
                            <?php echo $assertprice[0]['market_cap_change_percentage_24h']; ?>%  (below/above) the all-time high of <?php echo $assertprice[0]['current_price']; ?>.
                             With a current circulating supply of <?php echo $assertprice[0]['circulating_supply']; ?> and a maximum total supply of <?php echo $assertprice[0]['max_supply']; ?>, <?php echo  strtoupper($cointo);?>’s fully diluted market cap stands at
                             <?php echo $assertprice[0]['fully_diluted_valuation']; ?>.
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="buy-crypto-left">
                            <div class="heading">
                                <h2>What Is 1 (<?php echo  strtoupper($coinfrom);?>) to (<?php echo  strtoupper($cointo);?>)?</h2>
                               
                                <p>Currently, one (<?php echo  strtoupper($coinfrom);?>) is valued at <?php echo $finalratedata['rate'] ?>.With OKX, you can instantly convert 100+ cryptocurrencies to
                                 (<?php echo  strtoupper($cointo);?>) with no fees, no spreads, and zero slippage.</p>

<p>This page displays the real-time online exchange rate of (<?php echo  strtoupper($coinfrom);?>) against (<?php echo  strtoupper($cointo);?>). 
Additionally, our converter tool features a list of other popular cryptocurrencies that can be exchanged for 1 (<?php echo  strtoupper($coinfrom);?>).
</p>
                                ...
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel"
                                    ...
                                    <div class="imgbox">
                                     <!-- TradingView Widget BEGIN -->
                                      <iframe id="tabtradingrate" src="https://s.tradingview.com/mediumwidgetembed/?symbols=BITSTAMP%3ABTCUSD%7C1D&lineWidth=1&valuesTracking=1&fontFamily=-apple-system%2C%20BlinkMacSystemFont%2C%20Trebuchet%20MS%2C%20Roboto%2C%20Ubuntu%2C%20sans-serif&color=rgba(242%2C%2054%2C%2069%2C%201)&chartType=line&scaleMode=Normal&scalePosition=right&locale=in&fontColor=%23787b86&gridLineColor=rgba(42%2C%2046%2C%2057%2C%200.06)&chartOnly=1&width=100%25&height=100%25&colorTheme=light&utm_source=okxprod.wpengine.com&utm_medium=widget_new&utm_campaign=symbol-overview&page-uri=https://okxprod.wpengine.com/"></iframe>
...
<!-- TradingView Widget END -->
        ...
        <!-- Chart End -->
         <!-- Content-block Start -->
         <section class="content-block section-gap contentblocksec">
            <div class="container con_sec">
                <div class="heading">
                    <h3>Convert (<?php echo  strtoupper($coinfrom);?>) Into (<?php echo  strtoupper($cointo);?>) Using These Simple Steps</h3>
                    <div class="desccontent">
                        <h4>1. Create your free OKX account</h4>
                        <p>On the <a href="https://www.okx.com/">OKX website</a>, select the Sign Up button. You can sign up with your phone number, email address, telegram, or Google account. After choosing your preferred mode, enter the required information and follow the steps to activate your account.</p>

                        <h4>2. Verify your identity</h4>
                        <p>To begin converting (<?php echo  strtoupper($coinfrom);?>) to (<?php echo  strtoupper($cointo);?>), you must first verify your identity by providing relevant data and documents 
                        to fulfill the personal information and photo verification processes.</p>

                        <h4>3. Deposit (<?php echo  strtoupper($coinfrom);?>) into your OKX wallet</h4>
                        <p>Before converting your cryptocurrency, you must have a sufficient amount in your OKX wallet.</p>
                            <ul>
                                <li>Navigate to the <a href="#">"Deposit"</a> page and select (<?php echo  strtoupper($coinfrom);?>) and its relevant deposit network before hitting Continue.</li>
                                <li>Next, select the account in which to receive the funds. You may choose either the Funding Account or the Trading Account.</li>
                                <li>Proceed with entering the <?php echo  strtoupper($coinfrom);?>) deposit address from the dropdown menu. Alternatively, select Add new address and enter the relevant data.</li>
                                <li>Deposit (<?php echo  strtoupper($coinfrom);?>) into your OKX account by sending it to the chosen address. Review your deposit history by scrolling to the bottom of the "Deposit" section.</li>
                            </ul>
                            
                        <h4>4. Convert your assets</h4>
                            <ul>
                                <li>With your account topped up with the appropriate amount of (<?php echo  strtoupper($coinfrom);?>) coins, proceed with converting them as desired.</li>
                                <li>Head to the <a href="#">"Convert"</a> page.</li>
                                <li>Set (<?php echo  strtoupper($coinfrom);?>) as the crypto asset you want to convert and (<?php echo  strtoupper($cointo);?>) as the asset you want to get in exchange for it.</li>
                                <li>Enter the amount you wish to convert. Alternatively, you may enter the number of assets you want to receive first.</li>
                                <li>Select the relevant account (Funding Account or Trading Account) you wish to use.</li>
                                <li>Finally, click Convert to (<?php echo  strtoupper($coinfrom);?>).</li>
                                <li>It's that simple! Your requested crypto will now be reflected in your OKX account.</li>
                            </ul>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12 col-sm-12 table-responsive">
                        <table id="topcryptofiat" class="table">
                            <thead>
                                <tr id="trdling">
                                    <td>Crypto</td>
                                    <td>USD</td>
                             ...
                             <div class="accordion-item">
                                <h2 class="accordion-header" id="flush-headingOne">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        What is today's exchange rate of (<?php echo strtoupper($coinfrom); ?>) to (<?php echo  strtoupper($cointo);?>)?
                                    </button>
                                </h2>
                                <div id="flush-collapseOne" class="accordion-collapse collapse"
                                    aria-labelledby="flush-headingOne" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">Today's (<?php echo strtoupper($coinfrom); ?>) to (<?php echo  strtoupper($cointo);?>) is (<?php echo $finalratedata['rate'] ?>).</div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="flush-headingTwo">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        How did the (<?php echo strtoupper($coinfrom); ?>) to (<?php echo  strtoupper($cointo);?>) exchange rate change over the past 24 hours?
                                    </button>
                                </h2>
                                <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                    aria-labelledby="flush-headingTwo" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">How did the (<?php echo strtoupper($coinfrom); ?>) to (<?php echo  strtoupper($cointo);?>) exchange rate change over the past 24 hours?</div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="flush-headingThree">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        How many (<?php echo  strtoupper($cointo);?>) are there in total?
                                    </button>
                                </h2>
                                <div id="flush-collapseThree" class="accordion-collapse collapse"
                                    aria-labelledby="flush-headingThree" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">(<?php echo  strtoupper($cointo);?>) has a circulating supply of (<?php echo $finalratedata['rate'] ?>) (<?php echo  strtoupper($cointo);?>) and a maximum supply of (<?php echo $finalratedata['rate'] ?>) (<?php echo  strtoupper($cointo);?>) tokens.</div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="flush-headingFour">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        What is the recorded all-time high price of (<?php echo  strtoupper($cointo);?>)?
                                    </button>
                                </h2>
                                <div id="flush-collapseFour" class="accordion-collapse collapse"
                                    aria-labelledby="flush-headingFour" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">The all-time high price of (<?php echo  strtoupper($cointo);?>) is <?php echo $assertprice[0]['ath']; ?>.</div>
                                </div>
                            </div>
                            <div class="accordion-item">
                                <h2 class="accordion-header" id="flush-headingFive">
                                    <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                        ...
                                        Does converting (<?php echo strtoupper($coinfrom); ?>) into (<?php echo  strtoupper($cointo);?>) guarantee profit?
                                    </button>
                                </h2>
                                <div id="flush-collapseFive" class="accordion-collapse collapse"
                                    aria-labelledby="flush-headingFive" data-bs-parent="#accordionFlushExample">
                                    <div class="accordion-body">Like all cryptocurrencies, (<?php echo  strtoupper($cointo);?>) coins are also volatile and, therefore, carry investment risk. Before converting your tokens, you should do your own research (DYOR) and evaluate your risk appetite.</div>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    jQuery('#coinhiddenfrom').val(jQuery(this).data('value'));
         ...
         jQuery.ajax({
                           ...
                           success: function(data){
                               ...
                               jQuery('#coinferomustval').html(toamount);
                               jQuery('#coinferomust').html(from_bitcoin_id);
                               jQuery('#cointoustval').html(data);
                               jQuery('#cointocust').html(convert_to_coint_id);
                           },
    ...
    jQuery('#coinhiddenfrom').val(jQuery(this).data('value'));
         ...
         jQuery.ajax({
                           ...
                           success: function(data){
                               ...
                               jQuery('#coinferomustval').html(data);
                               jQuery('#coinferomust').html(from_bitcoin_id);
                               jQuery('#cointoustval').html(toamount);
                               jQuery('#cointocust').html(convert_to_coint_id);
                           },
                           error : function(jqXHR, textStatus, errorThrown) {
                           },
        ...
        jQuery("#swapconvertation").click(function(event){
           ...
           var html='<img  src="https://assets.coinlayer.com/icons/'+coinhiddenfrom+'.png">'+ coinhiddenfrom;
            ...
            if ( jQuery('#swapcoincoint').css('display') == 'none' || jQuery('#swapcoincoint').css("visibility") == "hidden"){
                ...
                jQuery('#coinferomust').html(coinhiddento);
                jQuery('#cointocust').html(coinhiddenfrom);
            }
            else{
                ...
                jQuery('#coinferomust').html(coinhiddenfrom);
                jQuery('#cointocust').html(coinhiddento);
            }
            ...
            setTimeout(function() {
                ...
                jQuery.ajax({  type: "POST",
                            ...
                            success: function(data){
                              ...
                              jQuery('#coinferomustval').html(converterfrom_amount);
